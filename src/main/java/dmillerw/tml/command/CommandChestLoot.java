...
public class CommandChestLoot extends CommandBase {
    ...
    public void processCommand(ICommandSender commandSender, String[] args) {
        ...
        // /loot spawnDebugChest pyramidJungleDispenser 10 4 10
            ...
            if (args[0].equalsIgnoreCase("spawnDebugChest")) {
                ...
                if (entityPlayerMP.worldObj.isAirBlock(x, y, z)
                        && World.doesBlockHaveSolidTopSurface(entityPlayerMP.worldObj, x, y - 1, z)) {
